...
AUTH_EMAIL = str(sys.argv[0])
AUTH_PASSWORD = str(sys.argv[1])
...
EA_AUTH_CODE = (json.loads((SESSION.get(EA_AUTH_URL)).text))
...
SESSION_ID = (json.loads((SESSION.post(API_CODE_URL, data=json.dumps(SESSION_DATA))).text))['result']['id']
